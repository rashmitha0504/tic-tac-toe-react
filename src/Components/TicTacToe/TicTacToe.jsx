...
import cross_icon from '../Assests/delete-button.png'
...
const TicTacToe = () => {
    ...
    const toggle=(e,num)=>{
        ...
        if(count%2===0){
            ...
            e.target.innerHTML=`<img src='${heart_icon}'> `;
            data[num]="o";
            setCount(++count);
        }
        checkWin();
    ...
    const won=(winner)=>{
        ...
        if(winner==="x"){
            ...
            titleRef.current.innerHTML=`Congratulations: <img src=${heart_icon} Wins/>`
        }
    }
